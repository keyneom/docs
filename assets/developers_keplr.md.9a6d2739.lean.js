...
`),Y,n(`
`),Q,n(`
`),s("span",L,[s("span",W,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),z,n(`
...
`),s("span",Qs,[s("span",Ls,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Ws,n(`
`),zs,n(`
